...
BULLET_MAC_INC=/usr/local/Cellar/bullet/2.86.1_1/include/bullet/
...
CC=g++
CPPFLAGS+=-g -std=c++11 $(SDL_CFLAGS) -I$(INCLUDE) -I$(LOCAL_INCLUDE) -I$(LIB_DIR) -I$(LOCAL_LIB_DIR) -I$(BULLET_INC) -I$(LUA_INC) -I$(BULLET_MAC_INC)
